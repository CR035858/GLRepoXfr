...
<body>
	<div class='container'>
		...
		<form action="/library/books/search" class="form-inline">

			<!-- Add a button -->
			<a href="/library/books/showFormForAdd"
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/library/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-warning btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a
							href="/library/books/delete?bookId=${tempBook.id}"
